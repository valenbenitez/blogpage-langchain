    ...
    <section className="mx-auto w-full max-w-2xl">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="mt-2 text-sm leading-6 text-muted sm:text-base">
          Actualizá el contenido, el estado y los datos del artículo.
        </p>
      </div>
      ...
      >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <Link
            className="inline-flex items-center justify-center rounded-lg px-4 py-2.5 text-sm font-medium text-muted transition hover:bg-subtle hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground"
            href={`/${post.slug}`}
          >
            Volver al artículo
          </Link>
