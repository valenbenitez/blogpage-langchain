    ...
    <div
      className={
        isWidget
          ...
          : "flex min-h-[28rem] flex-col rounded-xl border border-border bg-surface shadow-sm"
      }
    >
      <div
        ref={listRef}
        className={
          isWidget
            ...
            : "flex flex-1 flex-col gap-4 overflow-y-auto p-4 sm:p-6"
        }
      >
        {messages.length === 0 ? (
          <p className="m-auto max-w-sm text-center text-sm leading-6 text-muted">
            Preguntá sobre los artículos publicados.
          </p>
        ) : (
